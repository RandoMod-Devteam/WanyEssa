...
namespace WanyEssa.Graphics
{
    public class Particle
    {
        ...
        public Particle(Vector3 position, Vector3 velocity, Vector3 acceleration, Color color, Color endColor, float size, float lifeTime)
        {
            Position = position;
            Velocity = velocity;
        ...
        public void Update(float deltaTime)
        {
            ...
            Color = Color.Lerp(Color, EndColor, t);
        }
    }
    ...
    public class ParticleSystem
    {
        ...
        private Color _particleEndColor;
        ...
        public ParticleSystem(int maxParticles = 1000)
        {
            ...
            _emitDirection = Vector3.Forward;
        ...
        private void CreateParticle()
        {
            ...
            Vector3 direction = Vector3.RandomDirection(_emitDirection, _emitSpread);
        ...
        public void SetParticleColor(Color color, Color endColor)
        {
    ...
    public static class ParticlePresets
    {
        public static ParticleSystem CreateMuzzleFlash(Vector3 position, Vector3 direction)
        {
            ...
            system.SetParticleColor(new Color(1.0f, 0.8f, 0.2f, 1.0f), new Color(1.0f, 0.2f, 0.0f, 0.0f));
        ...
        public static ParticleSystem CreateImpactEffect(Vector3 position, Vector3 normal)
        {
            ...
            system.SetParticleColor(new Color(0.8f, 0.8f, 0.8f, 1.0f), new Color(0.5f, 0.5f, 0.5f, 0.0f));
        ...
        public static ParticleSystem CreateExplosionEffect(Vector3 position)
        {
            ...
            system.SetParticleAcceleration(new Vector3(0, -9.81f, 0));
            system.SetParticleColor(new Color(1.0f, 0.3f, 0.0f, 1.0f), new Color(1.0f, 1.0f, 0.0f, 0.0f));
        ...
        public static ParticleSystem CreateSmokeEffect(Vector3 position)
        {
            ...
            system.SetParticleColor(new Color(0.2f, 0.2f, 0.2f, 0.8f), new Color(0.1f, 0.1f, 0.1f, 0.0f));
            system.SetParticleSize(0.2f, 0.1f);
